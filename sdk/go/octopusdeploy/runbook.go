...
type Runbook struct {
	...
	ConnectivityPolicy RunbookConnectivityPolicyPtrOutput `pulumi:"connectivityPolicy"`
	...
	RetentionPolicy RunbookRetentionPolicyPtrOutput `pulumi:"retentionPolicy"`
...
func (o RunbookOutput) ConnectivityPolicy() RunbookConnectivityPolicyPtrOutput {
	return o.ApplyT(func(v *Runbook) RunbookConnectivityPolicyPtrOutput { return v.ConnectivityPolicy }).(RunbookConnectivityPolicyPtrOutput)
}
...
// Sets the runbook retention policy.
func (o RunbookOutput) RetentionPolicy() RunbookRetentionPolicyPtrOutput {
	return o.ApplyT(func(v *Runbook) RunbookRetentionPolicyPtrOutput { return v.RetentionPolicy }).(RunbookRetentionPolicyPtrOutput)
}
