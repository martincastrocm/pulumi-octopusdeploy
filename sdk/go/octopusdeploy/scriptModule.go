...
type ScriptModule struct {
	...
	Script ScriptModuleScriptPtrOutput `pulumi:"script"`
...
// The description of this script module.
func (o ScriptModuleOutput) Description() pulumi.StringOutput {
	return o.ApplyT(func(v *ScriptModule) pulumi.StringOutput { return v.Description }).(pulumi.StringOutput)
}
...
// The script associated with this script module.
func (o ScriptModuleOutput) Script() ScriptModuleScriptPtrOutput {
	return o.ApplyT(func(v *ScriptModule) ScriptModuleScriptPtrOutput { return v.Script }).(ScriptModuleScriptPtrOutput)
}
