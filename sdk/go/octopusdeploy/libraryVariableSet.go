...
type LibraryVariableSet struct {
	...
	TemplateIds   pulumi.StringMapOutput                `pulumi:"templateIds"`
...
type LibraryVariableSetState struct {
	...
	TemplateIds   pulumi.StringMapInput
...
// The description of this library variable set.
func (o LibraryVariableSetOutput) Description() pulumi.StringOutput {
	return o.ApplyT(func(v *LibraryVariableSet) pulumi.StringOutput { return v.Description }).(pulumi.StringOutput)
}
...
func (o LibraryVariableSetOutput) TemplateIds() pulumi.StringMapOutput {
	return o.ApplyT(func(v *LibraryVariableSet) pulumi.StringMapOutput { return v.TemplateIds }).(pulumi.StringMapOutput)
}
