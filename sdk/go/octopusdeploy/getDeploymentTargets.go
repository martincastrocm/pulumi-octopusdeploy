...
// The space ID associated with this resource.
func (o GetDeploymentTargetsResultOutput) SpaceId() pulumi.StringOutput {
	return o.ApplyT(func(v GetDeploymentTargetsResult) string { return v.SpaceId }).(pulumi.StringOutput)
}
