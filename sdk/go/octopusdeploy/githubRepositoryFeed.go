...
// The number of times a deployment should attempt to download a package from this feed before failing.
func (o GithubRepositoryFeedOutput) DownloadAttempts() pulumi.IntOutput {
	return o.ApplyT(func(v *GithubRepositoryFeed) pulumi.IntOutput { return v.DownloadAttempts }).(pulumi.IntOutput)
}

// The number of seconds to apply as a linear back off between download attempts.
func (o GithubRepositoryFeedOutput) DownloadRetryBackoffSeconds() pulumi.IntOutput {
	return o.ApplyT(func(v *GithubRepositoryFeed) pulumi.IntOutput { return v.DownloadRetryBackoffSeconds }).(pulumi.IntOutput)
}
