...
type GetAccountsResult struct {
	// A filter to search by a list of account types.  Valid account types are `AmazonWebServicesAccount`, `AmazonWebServicesRoleAccount`, `AmazonWebServicesOidcAccount`, `AzureServicePrincipal`, `AzureSubscription`, `None`, `SshKeyPair`, `Token`, or `UsernamePassword`.
	AccountType *string `pulumi:"accountType"`
...
// A Space ID to filter by. Will revert what is specified on the provider if not set.
func (o GetAccountsResultOutput) SpaceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAccountsResult) *string { return v.SpaceId }).(pulumi.StringPtrOutput)
}
