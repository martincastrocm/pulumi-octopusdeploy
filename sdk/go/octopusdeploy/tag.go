...
type Tag struct {
	...
	TagSetSpaceId pulumi.StringOutput `pulumi:"tagSetSpaceId"`
}
...
type tagState struct {
	...
	// The Space ID of the associated tag set. Required if the tag set is not in the same space as what is configured on the provider.
	TagSetSpaceId *string `pulumi:"tagSetSpaceId"`
}
...
type TagState struct {
	...
	// The Space ID of the associated tag set. Required if the tag set is not in the same space as what is configured on the provider.
	TagSetSpaceId pulumi.StringPtrInput
}
...
// The Space ID of the associated tag set. Required if the tag set is not in the same space as what is configured on the provider.
func (o TagOutput) TagSetSpaceId() pulumi.StringOutput {
	return o.ApplyT(func(v *Tag) pulumi.StringOutput { return v.TagSetSpaceId }).(pulumi.StringOutput)
}
