...
func GetProjectsOutput(ctx *pulumi.Context, args GetProjectsOutputArgs, opts ...pulumi.InvokeOption) GetProjectsResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (GetProjectsResultOutput, error) {
			...
			opts = internal.PkgInvokeDefaultOpts(opts)
			var rv GetProjectsResult
			secret, err := ctx.InvokePackageRaw("octopusdeploy:index/getProjects:getProjects", args, &rv, "", opts...)
			if err != nil {
...
// A Space ID to filter by. Will revert what is specified on the provider if not set
func (o GetProjectsResultOutput) SpaceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetProjectsResult) *string { return v.SpaceId }).(pulumi.StringPtrOutput)
}
