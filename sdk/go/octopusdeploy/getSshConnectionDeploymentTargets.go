...
// The space ID associated with this resource.
func (o GetSshConnectionDeploymentTargetsResultOutput) SpaceId() pulumi.StringOutput {
	return o.ApplyT(func(v GetSshConnectionDeploymentTargetsResult) string { return v.SpaceId }).(pulumi.StringOutput)
}
