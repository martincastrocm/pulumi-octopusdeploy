...
type Tenant struct {
	...
	ClonedFromTenantId pulumi.StringOutput `pulumi:"clonedFromTenantId"`
...
// The ID of the tenant from which this tenant was cloned.
func (o TenantOutput) ClonedFromTenantId() pulumi.StringOutput {
	return o.ApplyT(func(v *Tenant) pulumi.StringOutput { return v.ClonedFromTenantId }).(pulumi.StringOutput)
}

// The description of this tenant.
func (o TenantOutput) Description() pulumi.StringOutput {
	return o.ApplyT(func(v *Tenant) pulumi.StringOutput { return v.Description }).(pulumi.StringOutput)
}
