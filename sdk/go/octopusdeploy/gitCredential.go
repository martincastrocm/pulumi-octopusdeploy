...
func NewGitCredential(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("octopusdeploy:index/gitCredential:GitCredential", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetGitCredential(ctx *pulumi.Context,
	...
	var resource GitCredential
	err := ctx.ReadResource("octopusdeploy:index/gitCredential:GitCredential", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
// The description of this Git Credential.
func (o GitCredentialOutput) Description() pulumi.StringOutput {
	return o.ApplyT(func(v *GitCredential) pulumi.StringOutput { return v.Description }).(pulumi.StringOutput)
}
...
// The password for the Git credential.
func (o GitCredentialOutput) Password() pulumi.StringOutput {
	return o.ApplyT(func(v *GitCredential) pulumi.StringOutput { return v.Password }).(pulumi.StringOutput)
}

// The space ID associated with this Git Credential.
func (o GitCredentialOutput) SpaceId() pulumi.StringOutput {
	return o.ApplyT(func(v *GitCredential) pulumi.StringOutput { return v.SpaceId }).(pulumi.StringOutput)
}

// The Git credential authentication type.
func (o GitCredentialOutput) Type() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *GitCredential) pulumi.StringPtrOutput { return v.Type }).(pulumi.StringPtrOutput)
}

// The username for the Git credential.
func (o GitCredentialOutput) Username() pulumi.StringOutput {
	return o.ApplyT(func(v *GitCredential) pulumi.StringOutput { return v.Username }).(pulumi.StringOutput)
}
