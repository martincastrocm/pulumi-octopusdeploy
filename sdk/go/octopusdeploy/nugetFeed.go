...
type NugetFeed struct {
	...
	DownloadAttempts pulumi.IntOutput `pulumi:"downloadAttempts"`
	// The number of seconds to apply as a linear back off between download attempts.
	DownloadRetryBackoffSeconds pulumi.IntOutput    `pulumi:"downloadRetryBackoffSeconds"`
	...
	IsEnhancedMode pulumi.BoolOutput `pulumi:"isEnhancedMode"`
...
// The number of times a deployment should attempt to download a package from this feed before failing.
func (o NugetFeedOutput) DownloadAttempts() pulumi.IntOutput {
	return o.ApplyT(func(v *NugetFeed) pulumi.IntOutput { return v.DownloadAttempts }).(pulumi.IntOutput)
}

// The number of seconds to apply as a linear back off between download attempts.
func (o NugetFeedOutput) DownloadRetryBackoffSeconds() pulumi.IntOutput {
	return o.ApplyT(func(v *NugetFeed) pulumi.IntOutput { return v.DownloadRetryBackoffSeconds }).(pulumi.IntOutput)
}
...
// This will improve performance of the NuGet feed but may not be supported by some older feeds. Disable if the operation, Create Release does not return the latest version for a package.
func (o NugetFeedOutput) IsEnhancedMode() pulumi.BoolOutput {
	return o.ApplyT(func(v *NugetFeed) pulumi.BoolOutput { return v.IsEnhancedMode }).(pulumi.BoolOutput)
}
