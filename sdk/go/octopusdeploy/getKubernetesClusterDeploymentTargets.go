...
// The space ID associated with this resource.
func (o GetKubernetesClusterDeploymentTargetsResultOutput) SpaceId() pulumi.StringOutput {
	return o.ApplyT(func(v GetKubernetesClusterDeploymentTargetsResult) string { return v.SpaceId }).(pulumi.StringOutput)
}
