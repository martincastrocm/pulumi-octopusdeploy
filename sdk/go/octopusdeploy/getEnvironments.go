...
func GetEnvironmentsOutput(ctx *pulumi.Context, args GetEnvironmentsOutputArgs, opts ...pulumi.InvokeOption) GetEnvironmentsResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (GetEnvironmentsResultOutput, error) {
			...
			opts = internal.PkgInvokeDefaultOpts(opts)
			var rv GetEnvironmentsResult
			secret, err := ctx.InvokePackageRaw("octopusdeploy:index/getEnvironments:getEnvironments", args, &rv, "", opts...)
			if err != nil {
...
// The space ID associated with this environment.
func (o GetEnvironmentsResultOutput) SpaceId() pulumi.StringOutput {
	return o.ApplyT(func(v GetEnvironmentsResult) string { return v.SpaceId }).(pulumi.StringOutput)
}
