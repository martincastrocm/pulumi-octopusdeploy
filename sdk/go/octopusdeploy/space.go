...
type Space struct {
	...
	IsTaskQueueStopped pulumi.BoolOutput `pulumi:"isTaskQueueStopped"`
...
// The description of this space.
func (o SpaceOutput) Description() pulumi.StringOutput {
	return o.ApplyT(func(v *Space) pulumi.StringOutput { return v.Description }).(pulumi.StringOutput)
}
...
// Specifies the status of the task queue for this space.
func (o SpaceOutput) IsTaskQueueStopped() pulumi.BoolOutput {
	return o.ApplyT(func(v *Space) pulumi.BoolOutput { return v.IsTaskQueueStopped }).(pulumi.BoolOutput)
}
