...
// The description of this username/password account.
func (o UsernamePasswordAccountOutput) Description() pulumi.StringOutput {
	return o.ApplyT(func(v *UsernamePasswordAccount) pulumi.StringOutput { return v.Description }).(pulumi.StringOutput)
}
