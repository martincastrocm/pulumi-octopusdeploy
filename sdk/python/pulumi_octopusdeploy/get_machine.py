...
def get_machine(name: Optional[str] = None,
    ...
    return AwaitableGetMachineResult(
        endpoint_communicationstyle=pulumi.get(__ret__, 'endpoint_communicationstyle'),
        endpoint_id=pulumi.get(__ret__, 'endpoint_id'),
        endpoint_proxyid=pulumi.get(__ret__, 'endpoint_proxyid'),
        endpoint_tentacleversiondetails_upgradelocked=pulumi.get(__ret__, 'endpoint_tentacleversiondetails_upgradelocked'),
        endpoint_tentacleversiondetails_upgraderequired=pulumi.get(__ret__, 'endpoint_tentacleversiondetails_upgraderequired'),
        endpoint_tentacleversiondetails_upgradesuggested=pulumi.get(__ret__, 'endpoint_tentacleversiondetails_upgradesuggested'),
        endpoint_tentacleversiondetails_version=pulumi.get(__ret__, 'endpoint_tentacleversiondetails_version'),
        endpoint_thumbprint=pulumi.get(__ret__, 'endpoint_thumbprint'),
        endpoint_uri=pulumi.get(__ret__, 'endpoint_uri'),
        environments=pulumi.get(__ret__, 'environments'),
        haslatestcalamari=pulumi.get(__ret__, 'haslatestcalamari'),
        id=pulumi.get(__ret__, 'id'),
        isdisabled=pulumi.get(__ret__, 'isdisabled'),
        isinprocess=pulumi.get(__ret__, 'isinprocess'),
        machinepolicy=pulumi.get(__ret__, 'machinepolicy'),
        name=pulumi.get(__ret__, 'name'),
        roles=pulumi.get(__ret__, 'roles'),
        status=pulumi.get(__ret__, 'status'),
        statussummary=pulumi.get(__ret__, 'statussummary'),
        tenanteddeploymentparticipation=pulumi.get(__ret__, 'tenanteddeploymentparticipation'),
        tenantids=pulumi.get(__ret__, 'tenantids'),
        tenanttags=pulumi.get(__ret__, 'tenanttags'))
