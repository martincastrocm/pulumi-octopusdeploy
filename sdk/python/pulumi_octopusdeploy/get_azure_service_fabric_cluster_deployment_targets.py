...
class GetAzureServiceFabricClusterDeploymentTargetsResult:
    ...
    """
    def __init__(__self__, azure_service_fabric_cluster_deployment_targets=None, deployment_id=None, environments=None, health_statuses=None, id=None, ids=None, is_disabled=None, name=None, partial_name=None, roles=None, shell_names=None, skip=None, space_id=None, take=None, tenant_tags=None, tenants=None, thumbprint=None):
...
def get_azure_service_fabric_cluster_deployment_targets(deployment_id: Optional[str] = None,
    ...
    return AwaitableGetAzureServiceFabricClusterDeploymentTargetsResult(
        azure_service_fabric_cluster_deployment_targets=pulumi.get(__ret__, 'azure_service_fabric_cluster_deployment_targets'),
...
def get_azure_service_fabric_cluster_deployment_targets_output(deployment_id: Optional[pulumi.Input[Optional[str]]] = None,
