...
class GitCredentialArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] name: The name of this Git Credential.
        :param pulumi.Input[str] space_id: The space ID associated with this Git Credential.
...
class GitCredential(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            space_id: Optional[pulumi.Input[str]] = None,
            type: Optional[pulumi.Input[str]] = None,
            username: Optional[pulumi.Input[str]] = None) -> 'GitCredential':
        """
