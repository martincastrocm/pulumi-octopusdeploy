...
class EnvironmentArgs:
    def __init__(__self__, *,
                 ...
                 jira_extension_settings: Optional[pulumi.Input[Sequence[pulumi.Input['EnvironmentJiraExtensionSettingArgs']]]] = None,
                 jira_service_management_extension_settings: Optional[pulumi.Input[Sequence[pulumi.Input['EnvironmentJiraServiceManagementExtensionSettingArgs']]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 servicenow_extension_settings: Optional[pulumi.Input[Sequence[pulumi.Input['EnvironmentServicenowExtensionSettingArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['EnvironmentJiraExtensionSettingArgs']]] jira_extension_settings: Provides extension settings for the Jira integration for this environment.
        :param pulumi.Input[Sequence[pulumi.Input['EnvironmentJiraServiceManagementExtensionSettingArgs']]] jira_service_management_extension_settings: Provides extension settings for the Jira Service Management (JSM) integration for this environment.
        :param pulumi.Input[str] name: The name of this resource.
        :param pulumi.Input[Sequence[pulumi.Input['EnvironmentServicenowExtensionSettingArgs']]] servicenow_extension_settings: Provides extension settings for the ServiceNow integration for this environment.
        :param pulumi.Input[str] slug: The unique slug of this environment
    ...
    def jira_extension_settings(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['EnvironmentJiraExtensionSettingArgs']]]]:
        """
    ...
    def jira_extension_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['EnvironmentJiraExtensionSettingArgs']]]]):
        pulumi.set(self, "jira_extension_settings", value)

    @property
    @pulumi.getter(name="jiraServiceManagementExtensionSettings")
    def jira_service_management_extension_settings(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['EnvironmentJiraServiceManagementExtensionSettingArgs']]]]:
        """
    ...
    def jira_service_management_extension_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['EnvironmentJiraServiceManagementExtensionSettingArgs']]]]):
    ...
    def servicenow_extension_settings(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['EnvironmentServicenowExtensionSettingArgs']]]]:
        """
    ...
    def servicenow_extension_settings(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['EnvironmentServicenowExtensionSettingArgs']]]]):
...
class Environment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 allow_dynamic_infrastructure: Optional[pulumi.Input[bool]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 jira_extension_settings: Optional[pulumi.Input[Sequence[pulumi.Input[Union['EnvironmentJiraExtensionSettingArgs', 'EnvironmentJiraExtensionSettingArgsDict']]]]] = None,
                 jira_service_management_extension_settings: Optional[pulumi.Input[Sequence[pulumi.Input[Union['EnvironmentJiraServiceManagementExtensionSettingArgs', 'EnvironmentJiraServiceManagementExtensionSettingArgsDict']]]]] = None,
                 name: Optional[pulumi.Input[str]] = None,
                 servicenow_extension_settings: Optional[pulumi.Input[Sequence[pulumi.Input[Union['EnvironmentServicenowExtensionSettingArgs', 'EnvironmentServicenowExtensionSettingArgsDict']]]]] = None,
                 slug: Optional[pulumi.Input[str]] = None,
                 sort_order: Optional[pulumi.Input[int]] = None,
                 space_id: Optional[pulumi.Input[str]] = None,
                 use_guided_failure: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[str] description: The description of this environment.
        :param pulumi.Input[Sequence[pulumi.Input[Union['EnvironmentJiraExtensionSettingArgs', 'EnvironmentJiraExtensionSettingArgsDict']]]] jira_extension_settings: Provides extension settings for the Jira integration for this environment.
        :param pulumi.Input[Sequence[pulumi.Input[Union['EnvironmentJiraServiceManagementExtensionSettingArgs', 'EnvironmentJiraServiceManagementExtensionSettingArgsDict']]]] jira_service_management_extension_settings: Provides extension settings for the Jira Service Management (JSM) integration for this environment.
        :param pulumi.Input[str] name: The name of this resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['EnvironmentServicenowExtensionSettingArgs', 'EnvironmentServicenowExtensionSettingArgsDict']]]] servicenow_extension_settings: Provides extension settings for the ServiceNow integration for this environment.
        :param pulumi.Input[str] slug: The unique slug of this environment
        :param pulumi.Input[int] sort_order: The order number to sort an environment.
        :param pulumi.Input[str] space_id: The space ID associated with this environment.
        """
    ...
    @property
    @pulumi.getter(name="allowDynamicInfrastructure")
    def allow_dynamic_infrastructure(self) -> pulumi.Output[bool]:
        return pulumi.get(self, "allow_dynamic_infrastructure")
    ...
    @property
    @pulumi.getter(name="jiraExtensionSettings")
    def jira_extension_settings(self) -> pulumi.Output[Optional[Sequence['outputs.EnvironmentJiraExtensionSetting']]]:
        """
        Provides extension settings for the Jira integration for this environment.
        """
        return pulumi.get(self, "jira_extension_settings")
    ...
    @property
    @pulumi.getter(name="jiraServiceManagementExtensionSettings")
    def jira_service_management_extension_settings(self) -> pulumi.Output[Optional[Sequence['outputs.EnvironmentJiraServiceManagementExtensionSetting']]]:
        """
        Provides extension settings for the Jira Service Management (JSM) integration for this environment.
        """
        return pulumi.get(self, "jira_service_management_extension_settings")
    ...
    @property
    @pulumi.getter(name="servicenowExtensionSettings")
    def servicenow_extension_settings(self) -> pulumi.Output[Optional[Sequence['outputs.EnvironmentServicenowExtensionSetting']]]:
        """
        Provides extension settings for the ServiceNow integration for this environment.
        """
        return pulumi.get(self, "servicenow_extension_settings")
    ...
    @property
    @pulumi.getter(name="useGuidedFailure")
    def use_guided_failure(self) -> pulumi.Output[bool]:
        return pulumi.get(self, "use_guided_failure")
