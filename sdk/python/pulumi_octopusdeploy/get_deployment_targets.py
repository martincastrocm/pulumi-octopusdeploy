...
class GetDeploymentTargetsResult:
    ...
    """
    def __init__(__self__, communication_styles=None, deployment_id=None, deployment_targets=None, environments=None, health_statuses=None, id=None, ids=None, is_disabled=None, name=None, partial_name=None, roles=None, shell_names=None, skip=None, space_id=None, take=None, tenant_tags=None, tenants=None, thumbprint=None):
...
def get_deployment_targets(communication_styles: Optional[Sequence[str]] = None,
    ...
    return AwaitableGetDeploymentTargetsResult(
        communication_styles=pulumi.get(__ret__, 'communication_styles'),
        deployment_id=pulumi.get(__ret__, 'deployment_id'),
        deployment_targets=pulumi.get(__ret__, 'deployment_targets'),
