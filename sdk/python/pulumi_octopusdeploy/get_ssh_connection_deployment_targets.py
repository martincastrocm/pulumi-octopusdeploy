...
class GetSshConnectionDeploymentTargetsResult:
    ...
    """
    def __init__(__self__, deployment_id=None, environments=None, health_statuses=None, id=None, ids=None, is_disabled=None, name=None, partial_name=None, roles=None, shell_names=None, skip=None, space_id=None, ssh_connection_deployment_targets=None, take=None, tenant_tags=None, tenants=None, thumbprint=None):
...
def get_ssh_connection_deployment_targets(deployment_id: Optional[str] = None,
    ...
    return AwaitableGetSshConnectionDeploymentTargetsResult(
        ...
        ssh_connection_deployment_targets=pulumi.get(__ret__, 'ssh_connection_deployment_targets'),
