...
class GetPollingTentacleDeploymentTargetsResult:
    ...
    """
    def __init__(__self__, deployment_id=None, environments=None, health_statuses=None, id=None, ids=None, is_disabled=None, name=None, partial_name=None, polling_tentacle_deployment_targets=None, roles=None, shell_names=None, skip=None, space_id=None, take=None, tenant_tags=None, tenants=None, thumbprint=None):
...
def get_polling_tentacle_deployment_targets(deployment_id: Optional[str] = None,
    ...
    return AwaitableGetPollingTentacleDeploymentTargetsResult(
        ...
        polling_tentacle_deployment_targets=pulumi.get(__ret__, 'polling_tentacle_deployment_targets'),
