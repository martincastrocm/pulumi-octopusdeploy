...
__all__ = [
    'GetKubernetesAgentWorkersResult',
    'AwaitableGetKubernetesAgentWorkersResult',
    'get_kubernetes_agent_workers',
    'get_kubernetes_agent_workers_output',
]

@pulumi.output_type
class GetKubernetesAgentWorkersResult:
    """
    A collection of values returned by getKubernetesAgentWorkers.
    """
    def __init__(__self__, health_statuses=None, id=None, ids=None, is_disabled=None, kubernetes_agent_workers=None, name=None, partial_name=None, roles=None, shell_names=None, skip=None, space_id=None, take=None, thumbprint=None):
        ...
        if kubernetes_agent_workers and not isinstance(kubernetes_agent_workers, list):
            raise TypeError("Expected argument 'kubernetes_agent_workers' to be a list")
        pulumi.set(__self__, "kubernetes_agent_workers", kubernetes_agent_workers)
    ...
    @property
    @pulumi.getter(name="kubernetesAgentWorkers")
    def kubernetes_agent_workers(self) -> Sequence['outputs.GetKubernetesAgentWorkersKubernetesAgentWorkerResult']:
        """
        A list of kubernetes agent workers that match the filter(s).
        """
        return pulumi.get(self, "kubernetes_agent_workers")
...
class AwaitableGetKubernetesAgentWorkersResult(GetKubernetesAgentWorkersResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetKubernetesAgentWorkersResult(
            health_statuses=self.health_statuses,
            id=self.id,
            ids=self.ids,
            is_disabled=self.is_disabled,
            kubernetes_agent_workers=self.kubernetes_agent_workers,
            name=self.name,
...
def get_kubernetes_agent_workers(health_statuses: Optional[Sequence[str]] = None,
                                 ...
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetKubernetesAgentWorkersResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('octopusdeploy:index/getKubernetesAgentWorkers:getKubernetesAgentWorkers', __args__, opts=opts, typ=GetKubernetesAgentWorkersResult).value

    return AwaitableGetKubernetesAgentWorkersResult(
        health_statuses=pulumi.get(__ret__, 'health_statuses'),
        id=pulumi.get(__ret__, 'id'),
        ids=pulumi.get(__ret__, 'ids'),
        is_disabled=pulumi.get(__ret__, 'is_disabled'),
        kubernetes_agent_workers=pulumi.get(__ret__, 'kubernetes_agent_workers'),
...
@_utilities.lift_output_func(get_kubernetes_agent_workers)
def get_kubernetes_agent_workers_output(health_statuses: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                                        ...
                                        opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetKubernetesAgentWorkersResult]:
    """
    Provides information about existing kubernetes agent workers.
