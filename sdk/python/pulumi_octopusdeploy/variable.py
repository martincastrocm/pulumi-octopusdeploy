...
class VariableArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] type: The type of variable represented by this resource. Valid types are `AmazonWebServicesAccount`, `AzureAccount`, `GoogleCloudAccount`, `UsernamePasswordAccount`, `Certificate`, `Sensitive`, `String`, `WorkerPool`.
        ...
        :param pulumi.Input[str] space_id: The space ID associated with this variable.
        """
    ...
    @_utilities.deprecated("""This attribute is deprecated; please use owner_id instead.""")
...
class Variable(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 owner_id: Optional[pulumi.Input[str]] = None,
                 project_id: Optional[pulumi.Input[str]] = None,
                 prompt: Optional[pulumi.Input[Union['VariablePromptArgs', 'VariablePromptArgsDict']]] = None,
                 scope: Optional[pulumi.Input[Union['VariableScopeArgs', 'VariableScopeArgsDict']]] = None,
                 sensitive_value: Optional[pulumi.Input[str]] = None,
                 space_id: Optional[pulumi.Input[str]] = None,
                 type: Optional[pulumi.Input[str]] = None,
                 value: Optional[pulumi.Input[str]] = None,
    ...
    def _internal_init(__self__,
        ...
        secret_opts = pulumi.ResourceOptions(additional_secret_outputs=["sensitiveValue"])
