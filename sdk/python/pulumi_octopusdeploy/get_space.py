...
def get_space(name: Optional[str] = None,
    ...
    return AwaitableGetSpaceResult(
        ...
        is_task_queue_stopped=pulumi.get(__ret__, 'is_task_queue_stopped'),
        name=pulumi.get(__ret__, 'name'),
        slug=pulumi.get(__ret__, 'slug'),
        space_managers_team_members=pulumi.get(__ret__, 'space_managers_team_members'),
        space_managers_teams=pulumi.get(__ret__, 'space_managers_teams'))


@_utilities.lift_output_func(get_space)
def get_space_output(name: Optional[pulumi.Input[Optional[str]]] = None,
