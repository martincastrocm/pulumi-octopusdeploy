...
class NugetFeedArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] space_id: The space ID associated with this nuget feed.
...
class NugetFeed(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="downloadAttempts")
    def download_attempts(self) -> pulumi.Output[int]:
        """
        The number of times a deployment should attempt to download a package from this feed before failing.
        """
        return pulumi.get(self, "download_attempts")
    ...
    @property
    @pulumi.getter(name="downloadRetryBackoffSeconds")
    def download_retry_backoff_seconds(self) -> pulumi.Output[int]:
        """
        The number of seconds to apply as a linear back off between download attempts.
        """
        return pulumi.get(self, "download_retry_backoff_seconds")
    ...
    @property
    @pulumi.getter(name="isEnhancedMode")
    def is_enhanced_mode(self) -> pulumi.Output[bool]:
        """
        This will improve performance of the NuGet feed but may not be supported by some older feeds. Disable if the operation, Create Release does not return the latest version for a package.
        """
        return pulumi.get(self, "is_enhanced_mode")
