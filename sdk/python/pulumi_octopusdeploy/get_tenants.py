...
class GetTenantsResult:
    ...
    """
    def __init__(__self__, cloned_from_tenant_id=None, id=None, ids=None, is_clone=None, name=None, partial_name=None, project_id=None, skip=None, space_id=None, tags=None, take=None, tenants=None):
...
def get_tenants(cloned_from_tenant_id: Optional[str] = None,
    ...
    :param str space_id: The space ID associated with this tenants.
    ...
    return AwaitableGetTenantsResult(
        cloned_from_tenant_id=pulumi.get(__ret__, 'cloned_from_tenant_id'),
