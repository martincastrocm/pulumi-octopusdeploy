...
class MachinePolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[int] connection_connect_timeout: In nanoseconds. Minimum value: 10000000000 (10 seconds).
        :param pulumi.Input[int] connection_retry_sleep_interval: In nanoseconds.
        :param pulumi.Input[int] connection_retry_time_limit: In nanoseconds.
        :param pulumi.Input[str] description: The description of this machine policy.
        :param pulumi.Input[str] name: The name of this resource.
        :param pulumi.Input[int] polling_request_queue_timeout: In nanoseconds.
