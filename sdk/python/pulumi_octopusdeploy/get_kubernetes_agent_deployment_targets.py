...
__all__ = [
    'GetKubernetesAgentDeploymentTargetsResult',
    'AwaitableGetKubernetesAgentDeploymentTargetsResult',
    'get_kubernetes_agent_deployment_targets',
    'get_kubernetes_agent_deployment_targets_output',
]

@pulumi.output_type
class GetKubernetesAgentDeploymentTargetsResult:
    """
    A collection of values returned by getKubernetesAgentDeploymentTargets.
    """
    def __init__(__self__, deployment_id=None, environments=None, health_statuses=None, id=None, ids=None, is_disabled=None, kubernetes_agent_deployment_targets=None, name=None, partial_name=None, roles=None, shell_names=None, skip=None, space_id=None, take=None, tenant_tags=None, tenants=None, thumbprint=None):
        ...
        if kubernetes_agent_deployment_targets and not isinstance(kubernetes_agent_deployment_targets, list):
            raise TypeError("Expected argument 'kubernetes_agent_deployment_targets' to be a list")
        pulumi.set(__self__, "kubernetes_agent_deployment_targets", kubernetes_agent_deployment_targets)
    ...
    @property
    @pulumi.getter(name="kubernetesAgentDeploymentTargets")
    def kubernetes_agent_deployment_targets(self) -> Sequence['outputs.GetKubernetesAgentDeploymentTargetsKubernetesAgentDeploymentTargetResult']:
        """
        A list of kubernetes agent deployment targets that match the filter(s).
        """
        return pulumi.get(self, "kubernetes_agent_deployment_targets")
...
class AwaitableGetKubernetesAgentDeploymentTargetsResult(GetKubernetesAgentDeploymentTargetsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetKubernetesAgentDeploymentTargetsResult(
            ...
            kubernetes_agent_deployment_targets=self.kubernetes_agent_deployment_targets,
            name=self.name,
...
def get_kubernetes_agent_deployment_targets(deployment_id: Optional[str] = None,
                                            ...
                                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetKubernetesAgentDeploymentTargetsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('octopusdeploy:index/getKubernetesAgentDeploymentTargets:getKubernetesAgentDeploymentTargets', __args__, opts=opts, typ=GetKubernetesAgentDeploymentTargetsResult).value

    return AwaitableGetKubernetesAgentDeploymentTargetsResult(
        ...
        kubernetes_agent_deployment_targets=pulumi.get(__ret__, 'kubernetes_agent_deployment_targets'),
...
@_utilities.lift_output_func(get_kubernetes_agent_deployment_targets)
def get_kubernetes_agent_deployment_targets_output(deployment_id: Optional[pulumi.Input[Optional[str]]] = None,
                                                   ...
                                                   opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetKubernetesAgentDeploymentTargetsResult]:
    """
    Provides information about existing kubernetes agent deployment targets.
