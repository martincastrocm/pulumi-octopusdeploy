...
class GetLibraryVariableSetsResult:
    ...
    """
    def __init__(__self__, content_type=None, id=None, ids=None, library_variable_sets=None, partial_name=None, skip=None, space_id=None, take=None):
...
def get_library_variable_sets(content_type: Optional[str] = None,
    ...
    return AwaitableGetLibraryVariableSetsResult(
        ...
        library_variable_sets=pulumi.get(__ret__, 'library_variable_sets'),
