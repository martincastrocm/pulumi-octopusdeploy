...
class GetCertificatesResult:
    ...
    """
    def __init__(__self__, archived=None, certificates=None, first_result=None, id=None, ids=None, order_by=None, partial_name=None, search=None, skip=None, space_id=None, take=None, tenant=None):
...
def get_certificates(archived: Optional[str] = None,
    ...
    return AwaitableGetCertificatesResult(
        ...
        first_result=pulumi.get(__ret__, 'first_result'),
