...
class RunbookArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] multi_tenancy_mode: The tenanted deployment mode of the runbook. Valid modes are `Untenanted`, `TenantedOrUntenanted`, `Tenanted`
...
class Runbook(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 connectivity_policy: Optional[pulumi.Input[Union['RunbookConnectivityPolicyArgs', 'RunbookConnectivityPolicyArgsDict']]] = None,
                 default_guided_failure_mode: Optional[pulumi.Input[str]] = None,
                 description: Optional[pulumi.Input[str]] = None,
                 environment_scope: Optional[pulumi.Input[str]] = None,
                 environments: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 ...
                 name: Optional[pulumi.Input[str]] = None,
                 project_id: Optional[pulumi.Input[str]] = None,
                 retention_policy: Optional[pulumi.Input[Union['RunbookRetentionPolicyArgs', 'RunbookRetentionPolicyArgsDict']]] = None,
                 space_id: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[str] name: The name of the runbook in Octopus Deploy. This name must be unique.
        :param pulumi.Input[str] project_id: The project that this runbook belongs to.
        :param pulumi.Input[Union['RunbookRetentionPolicyArgs', 'RunbookRetentionPolicyArgsDict']] retention_policy: Sets the runbook retention policy.
        :param pulumi.Input[str] space_id: The space ID associated with this runbook.
        """
        ...
    @overload
    ...
    @property
    @pulumi.getter(name="connectivityPolicy")
    def connectivity_policy(self) -> pulumi.Output[Optional['outputs.RunbookConnectivityPolicy']]:
        return pulumi.get(self, "connectivity_policy")
    ...
    @property
    @pulumi.getter(name="retentionPolicy")
    def retention_policy(self) -> pulumi.Output[Optional['outputs.RunbookRetentionPolicy']]:
        """
        Sets the runbook retention policy.
        """
        return pulumi.get(self, "retention_policy")
