...
class GetProjectsResult:
    ...
    """
    def __init__(__self__, cloned_from_project_id=None, id=None, ids=None, is_clone=None, name=None, partial_name=None, projects=None, skip=None, space_id=None, take=None):
...
def get_projects(cloned_from_project_id: Optional[str] = None,
    ...
    :param str space_id: A Space ID to filter by. Will revert what is specified on the provider if not set
    ...
    return AwaitableGetProjectsResult(
        cloned_from_project_id=pulumi.get(__ret__, 'cloned_from_project_id'),
        id=pulumi.get(__ret__, 'id'),
        ids=pulumi.get(__ret__, 'ids'),
        is_clone=pulumi.get(__ret__, 'is_clone'),
