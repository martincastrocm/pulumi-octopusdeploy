...
namespace Pulumi.Octopusdeploy.Inputs
{
    ...
    public sealed class LifecyclePhaseArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.LifecyclePhaseReleaseRetentionPolicyArgs>? _releaseRetentionPolicies;

        /// <summary>
        /// Defines the retention policy for releases or tentacles.
        /// </summary>
        public InputList<Inputs.LifecyclePhaseReleaseRetentionPolicyArgs> ReleaseRetentionPolicies
        {
            get => _releaseRetentionPolicies ?? (_releaseRetentionPolicies = new InputList<Inputs.LifecyclePhaseReleaseRetentionPolicyArgs>());
            set => _releaseRetentionPolicies = value;
        }

        [Input("tentacleRetentionPolicies")]
        private InputList<Inputs.LifecyclePhaseTentacleRetentionPolicyArgs>? _tentacleRetentionPolicies;

        /// <summary>
        /// Defines the retention policy for releases or tentacles.
        /// </summary>
        public InputList<Inputs.LifecyclePhaseTentacleRetentionPolicyArgs> TentacleRetentionPolicies
        {
            get => _tentacleRetentionPolicies ?? (_tentacleRetentionPolicies = new InputList<Inputs.LifecyclePhaseTentacleRetentionPolicyArgs>());
