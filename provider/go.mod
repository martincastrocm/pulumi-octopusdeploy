module github.com/pulumi/pulumi-octopus/provider
...
require (
	github.com/OctopusDeploy/terraform-provider-octopusdeploy v0.30.7
...
require (
	...
	github.com/OctopusDeploy/go-octopusdeploy/v2 v2.50.0 // indirect
